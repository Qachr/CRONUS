...
func BootstrapDeltaBasedSetUp(cfg Config.CRONUSConfig) {
...
func Peer_DeltaNotUpdating(cfg Config.CRONUSConfig) {
...
func Peer_DeltaUpdating(cfg Config.CRONUSConfig) {
	sema := semaphore.NewWeighted(1)
...
func SendStateDelta(SetCrdt1 *CLSetDelta.CRDTCLSetDeltaBasedDag, ntpServ string, file *os.File, netID string, sema *semaphore.Weighted, cfg Config.CRONUSConfig) {
