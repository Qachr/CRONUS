...
func LogootBootstrap_OpBased(cfg Config.CRONUSConfig) {
...
func LogootNoUpdate_OpBased(cfg Config.CRONUSConfig) {
...
func LogootUpdate_OpBased(cfg Config.CRONUSConfig) {
	sema := semaphore.NewWeighted(1)
