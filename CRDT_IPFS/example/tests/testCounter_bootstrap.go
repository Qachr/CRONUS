...
// func sendToIPFS(ipfs *IpfsLink.IpfsLink, message []byte) (blocks.Block, error) {
...
// 	fils, timeSeek, timeDownload, err := IpfsLink.GetIPFS(ipfs, retrieving)
// 	if err != nil {
